...
export const show_master_popup = ()=>
{
    return {
        type: OPEN_POPUP,
        popup: MASTER_POPUP,
...
export const show_images_list_popup = (list)=>
{
    return{
        type: OPEN_POPUP,
...
export const open_popup = (popup_action, popup)=>
{
    ...
    return dispatch=>{
        return fetch(ADMIN_URL_GALLERY+popup,
        { 
            method:'GET', 
        })        
        .then(res=>res.json())
        .then(res=>dispatch(show_images_list_popup(res)))
        }    
}
...
export const set_image_list_index = (index)=>{
    return{
